...
//verificar que exista el idI
    ...
    if(isset($_GET['idP']) && $_GET['idP']!="") //verificar el id usario solo elimine sus imagenes correspondientes
    {
        $conn= ConectarBD();
        $qry= "DELETE FROM partidos WHERE idPartido=" . $_GET['idP'];
...
<script type="text/javascript">
	...
	window.location.href='admiPartido.php';
</script>
<style type="text/css">
.alerta{
