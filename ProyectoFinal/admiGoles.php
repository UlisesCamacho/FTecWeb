...
if(!isset($_SESSION['idUsuario']) || $_SESSION['Rol']!='Administrador') header("location:http://localhost/ProyectoFinal/CanCerberoPortada.php");
    ...
    || isset($_POST['jugador']) && $_POST['jugador']!="")   // validar el envio del formulario.
    {
            ...
            $qry="INSERT INTO goles (idPartido, idEquipo, idJugador, cantidad)
                    VALUES ('$partido','$equipo','$jugador','$goles')";
                        if(mysqli_query($conn,$qry))
                        {
                           
                            header("location:http://localhost/ProyectoFinal/admiGoles.php");
                        }
                        else{
...
function verificaFRM()
{
    ...
    document.getElementById("jugador").value =="" || document.getElementById("goles").value =="" )
    {
...
<div class="tituloPagina"><h2>Goles</h2></div>
<div class="contGrande">
<div id="ligas">
         <form action= "admiGoles.php" method="POST"  onsubmit="verificaFRM()">
         <label>Partido:</label>
    ...
    <input type="number" name="goles" id="goles" min="0" max="200"><br><br><br>
    

         <input type="submit" value="Insertar Goles"/><br><br>
...
<table>
    ...
    <tr>
        ...
        <td><?php  echo "<a href='modificaRegistroGol.php?idG=".$mostrar['idGol']."'> <button type='button' class='btn btn-success'>Modificar</button></a>" ?></td>
        <td><?php  echo "<a href='eliminaRegistroGol.php?idG=".$mostrar['idGol']."'> <button type='button' class='btn btn-success'>Eliminar</button></a>" ?></td>
