...
if(!isset($_SESSION['idUsuario']) || $_SESSION['Rol']!='Administrador') header("location:http://localhost/ProyectoFinal/CanCerberoPortada.php");
    ...
    || isset($_POST['jugador']) && $_POST['jugador']!="")   // validar el envio del formulario.
    {
            ...
            $qry="INSERT INTO amonestaciones (idPartido, idEquipo, idJugador, tipo)
                    VALUES ('$partido','$equipo','$jugador','$falta')";
...
<div class="tituloPagina"><h2>Amonestaciones</h2></div>
<div class="contGrande">
<div id="ligas">
         <form action= "admiAmonestaciones.php" method="POST"  onsubmit="verificaFRM()">
         <label>Partido:</label>
    ...
    <input type="text" name="falta" id="falta"><br><br><br>
         ...
         <input type="submit" value="Insertar Amonestaciones"/><br><br>
...
<table>
    <thead>
        ...
        <?php 
        $sql= "SELECT * FROM amonestaciones";
        $rs=mysqli_query($conn,$sql);
        while($mostrar=mysqli_fetch_array($rs)){
        ?>
    <tr>
         <td><?php echo $mostrar['idAmonestacion'] ?></td>
        ...
        <td><?php  echo "<a href='modificaRegistroAmonestacion.php?idA=".$mostrar['idAmonestacion']."'> <button type='button' class='btn btn-success'>Modificar</button></a>" ?></td>
        <td><?php  echo "<a href='eliminaRegistroAmonestacion.php?idA=".$mostrar['idAmonestacion']."'> <button type='button' class='btn btn-success'>Eliminar</button></a>" ?></td>
