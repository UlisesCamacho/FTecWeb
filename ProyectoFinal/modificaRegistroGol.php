...
{      
            ...
            $qry = "UPDATE goles SET idPartido='". $partido . "', idEquipo='". $equipo . "',
            idJugador='". $jugador . "', cantidad='". $goles . "' WHERE idGol=". $_GET['idG'];
            $rs = mysqli_query($conn, $qry);
            header("location:http://localhost/ProyectoFinal/admiGoles.php");
    
}
if(isset($_GET['idG']) && $_GET['idG']!= "")
{
    $qry = "SELECT * FROM goles WHERE idGol = ". $_GET['idG'];
    $rs = mysqli_query($conn, $qry);
...
<div id="login">
<form method="GET" action="modificaRegistroGol.php" onsubmit="return verificaFRM()">
...
<label>Partido:</label>
    ...
    <input type="number" name="goles" id="goles" min="0" max="200"><br><br><br>
         ...
         <input type="submit" value="Modificar Goles"/><br><br>
			<input type="reset" value="Cancelar">
			
			
         </form>
         </div>
<div class="regreso"><a href="admiGoles.php">Regresar</a></div>
