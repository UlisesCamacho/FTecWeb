...
//verificar que exista el idI
    ...
    if(isset($_GET['idG']) && $_GET['idG']!="") //verificar el id usario solo elimine sus imagenes correspondientes
    {
        $conn= ConectarBD();
        $qry= "DELETE FROM goles WHERE idGol=" . $_GET['idG'];
...
<script type="text/javascript">
	...
	window.location.href='admiGoles.php';
</script>
<style type="text/css">
.alerta{
